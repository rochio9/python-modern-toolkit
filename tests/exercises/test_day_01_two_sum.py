...
class TestTwoSumExamples:
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param([2, 7, 11, 15], 9, (0, 1), id="basic_sorted"),
            pytest.param([3, 2, 4], 6, (1, 2), id="unsorted"),
            pytest.param([3, 3], 6, (0, 1), id="duplicates_only"),
            pytest.param([-1, -2, -3, -4, -5], -8, (2, 4), id="all_negatives"),
        ],
    )
